...
import type { FlashMessageParams, FlashMessageOptions, FlashMessage } from '../../types';
...
const flashMessage = (flashMessage: FlashMessagePlugin, options: FlashMessageOptions): FlashMessage => {
    return {
